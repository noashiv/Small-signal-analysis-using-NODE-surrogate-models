!  MODEL NAME : inj_ATL1                
!  MODEL DESCRIPTION FILE : ATL1_workFile.txt
!  Data :
...
!       prm( 64)=  dfdn  
!       prm( 65)=  theta0  
!       prm( 66)=  P0   initial active power
!       prm( 67)=  Q0   initial reactive power
!       prm( 68)=  P0_unit  
!       prm( 69)=  Q0_unit  
!       prm( 70)=  V0   initial voltage magnitude at bus
!       prm( 71)=  iP0   current alignment
!       prm( 72)=  iQ0  
!       prm( 73)=  vd0   voltage alignment
!       prm( 74)=  vq0  
!       prm( 75)=  md0   modulation indices
!       prm( 76)=  mq0  
!       prm( 77)=  idc0   DC link current
!       prm( 78)=  iT0  
!       prm( 79)=  wm0  
!       prm( 80)=  Te0  
!       prm( 81)=  Tc0  
...
subroutine inj_ATL1(nb,name,mode,nbxvar,nbzvar,nbdata,nbaddpar,prm,parname,nbobs, &
...
!P0_unit = -{P0}*{Sbs}/{Sb}
      prm( 68)= -prm( 66)*prm(  2)/prm(  1)

!Q0_unit = -{Q0}*{Sbs}/{Sb}
      prm( 69)= -prm( 67)*prm(  2)/prm(  1)

!V0 = dsqrt([vx]**2+[vy]**2)
      prm( 70)= dsqrt(vx**2+vy**2)

!iP0 =  (-[ix]*cos({theta0})-[iy]*sin({theta0}))*{Sbs}/{Sb}
      prm( 71)=  (-ix*cos(prm( 65))-iy*sin(prm( 65)))*prm(  2)/prm(  1)

!iQ0 =  (-[ix]*sin({theta0})+[iy]*cos({theta0}))*{Sbs}/{Sb}
      prm( 72)=  (-ix*sin(prm( 65))+iy*cos(prm( 65)))*prm(  2)/prm(  1)

!vd0 = [vx]*cos({theta0})+[vy]*sin({theta0})
      prm( 73)= vx*cos(prm( 65))+vy*sin(prm( 65))

!vq0 = [vx]*sin({theta0})-[vy]*cos({theta0})
      prm( 74)= vx*sin(prm( 65))-vy*cos(prm( 65))

!md0 = 1/{vdc_star}*({vd0}+{lt}*{w0}*{iQ0}-{rt}*{iP0})
      prm( 75)= 1/prm(  3)*(prm( 73)+prm( 18)*prm( 51)*prm( 72)-prm( 17)*prm( 71))

!mq0 = 1/{vdc_star}*({vq0}-{lt}*{w0}*{iP0}-{rt}*{iQ0})
      prm( 76)= 1/prm(  3)*(prm( 74)-prm( 18)*prm( 51)*prm( 71)-prm( 17)*prm( 72))

!idc0 = {md0}*{iP0}+{mq0}*{iQ0}
      prm( 77)= prm( 75)*prm( 71)+prm( 76)*prm( 72)

!iT0 = {Tnm}*{kT}/(2*{kT}**2+2*{ra}*{b}) + dsqrt(({Tnm}*{kT}/(2*{kT}**2+2*{ra}*{b}))**2-({ra}*{b}*{iF}**2-{b}*{idc0}*{vdc_star})/({kT}**2+{ra}*{b}))
      prm( 78)= prm( 25)*prm( 21)/(2*prm( 21)**2+2*prm( 22)*prm( 24)) + dsqrt((prm( 25)*prm( 21)/(2*prm( 21)**2+2*prm( 22)*prm( 24)))**2-(prm( 22)*prm( 24)*prm( 26)**2-prm( 24)*prm( 77)*prm(  3))/(prm( 21)**2+prm( 22)*prm( 24)))

!wm0 = 1/{b}*({kT}*{iT0}-{Tnm})
      prm( 79)= 1/prm( 24)*(prm( 21)*prm( 78)-prm( 25))

!Te0 = {iT0}*{kT}
      prm( 80)= prm( 78)*prm( 21)
...
!mdr =  {lt}/{vdc_star}*{iQ0}*{w0}-{md0}
      x( 33)= prm( 18)/prm(  3)*prm( 72)*prm( 51)-prm( 75)

!mqr =  -{lt}/{vdc_star}*{iP0}*{w0}-{mq0}
      x( 34)= -prm( 18)/prm(  3)*prm( 71)*prm( 51)-prm( 76)
...
!didc =  {md0}*{iP0}+{mq0}*{iQ0}-{idc0}
      x( 40)= prm( 75)*prm( 71)+prm( 76)*prm( 72)-prm( 77)
...
!& pwlin4            ! limit active power during undervoltage
      ...
      elseif(0<=x( 10) .and. x( 10)<0.9)then
         z( 17)=  1
      elseif(0.89<=x( 10) .and. x( 10)<0.90)then
         z( 17)=  2
      elseif(0.90<=x( 10) .and. x( 10)<1.5)then
         z( 17)=  3
      endif
...
!& pwlin4            ! limit active power during undervoltage
      select case (z( 17))
         case (  1)
            f( 85)=prm( 41)+ ( (prm( 41)-prm( 41))*(x( 10)-0)/(0.89-0) ) -x( 31)
         case (  2)
            f( 85)=prm( 41)+ ( (prm( 42)-prm( 41))*(x( 10)-0.89)/(0.90-0.89) ) -x( 31)
         case (  3)
            f( 85)=prm( 42)+ ( (prm( 42)-prm( 42))*(x( 10)-0.90)/(1.5-0.90) ) -x( 31)
      end select
...
!& algeq
      f( 91)=x( 77)-x( 76)*prm( 63)

!& algeq
      f( 92)=x( 78)-x( 76)*prm( 64)
...
!& pwlin4            ! limit active power during undervoltage
      ...
      elseif(x( 10)>=1.5)then
         z( 17)=  3
      elseif(0<=x( 10) .and. x( 10)<0.89)then
         z( 17)=  1
      elseif(0.89<=x( 10) .and. x( 10)<0.90)then
         z( 17)=  2
      elseif(0.90<=x( 10) .and. x( 10)<1.5)then
