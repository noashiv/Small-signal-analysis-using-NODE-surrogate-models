!  MODEL NAME : inj_IBG22ra             
!  MODEL DESCRIPTION FILE : IBG22ra.txt
!  Data :
!       prm(  1)=  Imax
!       prm(  2)=  IN
!       prm(  3)=  Iprate
...
subroutine inj_IBG22ra(nb,name,mode,nbxvar,nbzvar,nbdata,nbaddpar,prm,parname,nbobs, &
...
!& lim           ! limit power change during underfrequencies
      eqtyp( 69)=0
      if(x( 79)>(prm( 57)+prm( 42)))then
         z( 24)=1
      elseif(x( 79)<0.0000000001)then
         z( 24)=-1
      else
         z( 24)=0
      endif
...
!& lim           ! limit power change during underfrequencies
      eqtyp( 71)=0
      if(x( 81)>(-0.0000000001))then
         z( 25)=1
      elseif(x( 81)<prm( 42))then
         z( 25)=-1
      else
         z( 25)=0
      endif
...
!& algeq             ! compute status
      f(  9)=x( 75) - x( 28)*x( 47)*x( 49)*x( 72)*x( 58)
...
!& tf1p2lim			! temporary current is
      select case (z(  4))
         case(0)
            f( 14)=x( 83)-1*x( 11)+x( 31)
         case(1)
            f( 14)=x( 83)-prm( 53)*prm(  4)
         case(-1)
            f( 14)=x( 83)-prm( 49)*prm(  4)
      end select
      select case (z(  5))
         case(0)
            f( 15)=x( 83)
...
!& tf1p2lim
      select case (z( 12))
         case(0)
            f( 35)=x( 85)-1*x( 59)+x( 58)
         case(1)
            f( 35)=x( 85)-prm( 54)*prm( 56)
         case(-1)
            f( 35)=x( 85)-prm( 49)*prm( 56)
      end select
      select case (z( 13))
         case(0)
            f( 36)=x( 85)
...
!& pictl
      ...
      f( 52)=0.5/(prm( 10)*0.001)                                                                                                                                                                                                                                                                                        *x( 20)+x( 86)-x( 55)
...
!& algeq       ! compute unlimited power change during underfrequencies
      f( 68)=-x( 79) + (x( 64)*50)/2 * (prm( 57) + prm( 42))
...
!& lim           ! limit power change during underfrequencies
      select case (z( 24))
         case(0)
            f( 69)=x( 80)-x( 79)
         case(-1)
            f( 69)=x( 80)-0.0000000001
         case(1)
            f( 69)=x( 80)-(prm( 57)+prm( 42))
      end select

!& algeq       ! compute unlimited power change during overfrequency
      f( 70)=-x( 81) - (x( 64)*50)/2 * prm( 42)
...
!& algeq
      f( 74)=x( 50)+prm( 42)-x( 66)

!& algeq             ! alignment
      f( 75)=x( 21) - x( 41)*cos(x(  6)) - x( 42)*sin(x(  6))

!& algeq
      f( 76)=x( 20) + x( 41)*sin(x(  6)) - x( 42)*cos(x(  6))
...
!& algeq
      f( 79)=x(  1) - x(  9)*cos(x(  6)) - x( 10)*sin(x(  6))

!& algeq
      f( 80)=x(  2) - x(  9)*sin(x(  6)) + x( 10)*cos(x(  6))

!& algeq                ! frequency deviation in Hz
      f( 81)=-x( 67) + x( 45)-prm( 55)*50

!& tfder1p               ! Rocof measurement in Hz/s
      f( 82)=-x( 87)+x( 67)
      if (prm( 35)< 0.005)then
         f( 83)=1/prm( 35)*x( 67)-x( 68)
      else
         f( 83)=1/prm( 35)*(x( 67)-x( 87))-x( 68)
      endif
...
!& hyst
      if(z( 29) == 1)then
         f( 87)=x( 72)-1.-(1.-1.)*(x( 71)-1.1)/(1.1-0.9)
      else
         f( 87)=x( 72)-0.-(0.-0.)*(x( 71)-0.9)/(1.1-0.9)
      endif
...
!& tf1p2lim			! temporary current is
      select case (z(  4))
         case(0)
            if(x( 83)>prm( 53)*prm(  4))then
               z(  4)=1
            elseif(x( 83)<prm( 49)*prm(  4))then
               z(  4)=-1
            endif
         case(1)
            if(1*x( 11)-x( 31)<prm( 53)*prm(  4))then
...
!& timer5
      ...
      if(z(  8) == 0)then
         ...
         elseif(x( 33) > (-(prm( 28)*prm( 13) + (1-prm( 28))*prm( 30))))then
            if(x( 84) > prm(  6)+(0.-prm(  6))*(x( 33)-(-(prm( 28)*prm( 13) + (1-prm( 28))*prm( 30))))/((-(prm( 28)*prm( 13) + (1-prm( 28))*prm( 30)))-(-(prm( 28)*prm( 13) + (1-prm( 28))*prm( 30)))))then
               z(  8)=1
            endif
         elseif(x( 33) > (-(prm( 28)*prm( 14) + (1-prm( 28))*prm( 30))))then
            if(x( 84) > prm(  6)+(prm(  6)-prm(  6))*(x( 33)-(-(prm( 28)*prm( 14) + (1-prm( 28))*prm( 30))))/((-(prm( 28)*prm( 13) + (1-prm( 28))*prm( 30)))-(-(prm( 28)*prm( 14) + (1-prm( 28))*prm( 30)))))then
               z(  8)=1
            endif
         elseif(x( 33) > (-(prm( 28)*prm( 14) + (1-prm( 28))*prm( 30))))then
            if(x( 84) > prm(  8)+(prm(  6)-prm(  8))*(x( 33)-(-(prm( 28)*prm( 14) + (1-prm( 28))*prm( 30))))/((-(prm( 28)*prm( 14) + (1-prm( 28))*prm( 30)))-(-(prm( 28)*prm( 14) + (1-prm( 28))*prm( 30)))))then
               z(  8)=1
            endif
         elseif(x( 33) > (-prm( 12)))then
            if(x( 84) > prm(  7)+(prm(  8)-prm(  7))*(x( 33)-(-prm( 12)))/((-(prm( 28)*prm( 14) + (1-prm( 28))*prm( 30)))-(-prm( 12))))then
               z(  8)=1
            endif
         endif
      endif
...
!& tf1p2lim
      select case (z( 12))
         case(0)
            if(x( 85)>prm( 54)*prm( 56))then
               z( 12)=1
            elseif(x( 85)<prm( 49)*prm( 56))then
               z( 12)=-1
            endif
         case(1)
            if(1*x( 59)-x( 58)<prm( 54)*prm( 56))then
