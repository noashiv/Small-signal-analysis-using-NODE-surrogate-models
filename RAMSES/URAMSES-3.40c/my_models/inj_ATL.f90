!  MODEL NAME : inj_ATL                 
!  MODEL DESCRIPTION FILE : ATL_test.txt
!  Data :
...
subroutine inj_ATL(nb,name,mode,nbxvar,nbzvar,nbdata,nbaddpar,prm,parname,nbobs, &
...
!& algeq                                             ! DC link current, multiply by status
      eqtyp( 41)=0
...
!& algeq         ! droop control with deadband
      eqtyp( 92)=0
...
!& pictl                                             ! PLL
      f( 18)=0.1/(prm(  5)*0.001)**2                                                                                                                                                                                                                                                                                     *x(  4)
      f( 19)=0.5/(prm(  5)*0.001)                                                                                                                                                                                                                                                                                        *x(  4)+x( 91)-x( 24)

!& algeq                                             ! frequency deviation
      f( 20)=x( 21) - x( 24) + omega*prm( 52)

!& algeq
      f( 21)=x( 22) -x( 21)*x( 50)

!& algeq                                             ! compute and filter frequency
      f( 22)=-x( 26)+x( 24)/prm( 52)*fnom
...
!& pictl
      f( 29)=prm( 11)                                                                                                                                                                                                                                                                                                    *x( 12)
      f( 30)=prm( 10)                                                                                                                                                                                                                                                                                                    *x( 12)+x( 93)-x( 33)

!& algeq                                             ! q-axis current control
      f( 31)=-x( 32) + x( 29)*dsqrt(1-prm(  4))
...
!& algeq                                             ! DC link current, multiply by status
      f( 41)=-x( 39) + (x( 47)*prm( 21)*x( 45) + prm( 22)*x( 45)**2) / max(1.d-3,x( 27))
...
!& algeq                                             ! power mismatch
      f( 45)=-x( 16) + x( 82)*x( 20)-x( 17)

!& pictl                                             ! power control
      f( 46)=prm( 13)                                                                                                                                                                                                                                                                                                    *x( 16)
      f( 47)=prm( 12)                                                                                                                                                                                                                                                                                                    *x( 16)+x( 95)-x( 41)
...
!& algeq                                             ! torque equations
      f( 54)=-x( 48) + prm( 21)*x( 45)

!& algeq
      f( 55)=-x( 49) + x( 48)-x( 82)*prm( 79)

!& tf1p                                              ! motor inertia
      f( 56)=(-x( 47)+1/prm( 24)*x( 49))

!& algeq
      f( 57)=x( 52) - x( 10) +prm( 29)
...
!& tfder1p               ! Rocof measurement in Hz/s
      ...
      if (prm( 39)< 0.005)then
         f( 81)=1/prm( 39)*x( 23)-x( 69)
      else
         f( 81)=1/prm( 39)*(x( 23)-x( 98))-x( 69)
      endif
...
!& hyst
      if(z( 16) == 1)then
         f( 87)=x( 73)-1.-(1.-1.)*(x( 72)-1.1)/(1.1-0.9)
      else
         f( 87)=x( 73)-0.-(0.-0.)*(x( 72)-0.9)/(1.1-0.9)
      endif

!& pwlin4            ! limit active power during undervoltage
      select case (z( 17))
         case (  1)
            f( 88)=prm( 41)+ ( (prm( 41)-prm( 41))*(x( 10)-0)/(0.9-0) ) -x( 31)
         case (  2)
            f( 88)=prm( 41)+ ( (prm( 42)-prm( 41))*(x( 10)-0.9)/(0.93-0.9) ) -x( 31)
         case (  3)
            f( 88)=prm( 42)+ ( (prm( 42)-prm( 42))*(x( 10)-0.93)/(1.5-0.93) ) -x( 31)
      end select
...
!& tf1p2lim
      select case (z( 18))
         case(0)
            f( 90)=x( 99)-1*x( 31)+x( 30)
         case(1)
            f( 90)=x( 99)-prm( 59)*prm( 56)
         case(-1)
            f( 90)=x( 99)-prm( 60)*prm( 56)
      end select
      select case (z( 19))
         case(0)
            f( 91)=x( 99)
...
!& db
      select case (z( 20))
         case(0)
            f( 93)=x( 76)
         case(-1)
            f( 93)=x( 76)-0.-1.*(x( 75)-prm( 45))
         case(1)
            f( 93)=x( 76)-0.-1.*(x( 75)-prm( 46))
      end select

!& algeq
      f( 94)=x( 77)-x( 76)*prm( 47)

!& algeq
      f( 95)=x( 78)-x( 76)*prm( 48)
...
!& timer5
      ...
      if(z(  6) == 0)then
         ...
         elseif(x( 59) > (-(prm( 43)*prm( 30) + (1-prm( 43))*prm( 36))))then
            if(x( 97) > prm( 33)+(0.-prm( 33))*(x( 59)-(-(prm( 43)*prm( 30) + (1-prm( 43))*prm( 36))))/((-(prm( 43)*prm( 30) + (1-prm( 43))*prm( 36)))-(-(prm( 43)*prm( 30) + (1-prm( 43))*prm( 36)))))then
               z(  6)=1
            endif
         elseif(x( 59) > (-(prm( 43)*prm( 31) + (1-prm( 43))*prm( 36))))then
            if(x( 97) > prm( 33)+(prm( 33)-prm( 33))*(x( 59)-(-(prm( 43)*prm( 31) + (1-prm( 43))*prm( 36))))/((-(prm( 43)*prm( 30) + (1-prm( 43))*prm( 36)))-(-(prm( 43)*prm( 31) + (1-prm( 43))*prm( 36)))))then
               z(  6)=1
            endif
         elseif(x( 59) > (-(prm( 43)*prm( 31) + (1-prm( 43))*prm( 36))))then
            if(x( 97) > prm( 35)+(prm( 33)-prm( 35))*(x( 59)-(-(prm( 43)*prm( 31) + (1-prm( 43))*prm( 36))))/((-(prm( 43)*prm( 31) + (1-prm( 43))*prm( 36)))-(-(prm( 43)*prm( 31) + (1-prm( 43))*prm( 36)))))then
               z(  6)=1
            endif
         elseif(x( 59) > (-prm( 32)))then
            if(x( 97) > prm( 34)+(prm( 35)-prm( 34))*(x( 59)-(-prm( 32)))/((-(prm( 43)*prm( 31) + (1-prm( 43))*prm( 36)))-(-prm( 32))))then
               z(  6)=1
            endif
         endif
      endif
...
!& tf1p2lim
      select case (z( 18))
         case(0)
            if(x( 99)>prm( 59)*prm( 56))then
               z( 18)=1
            elseif(x( 99)<prm( 60)*prm( 56))then
               z( 18)=-1
            endif
         case(1)
            if(1*x( 31)-x( 30)<prm( 59)*prm( 56))then
