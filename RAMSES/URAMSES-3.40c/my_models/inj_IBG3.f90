!  MODEL NAME : inj_IBG3                
!  MODEL DESCRIPTION FILE : IBG3_workFile.txt
!  Data :
!       prm(  1)=  PMPP
!       prm(  2)=  PN
!       prm(  3)=  Iprate
...
subroutine inj_IBG3(nb,name,mode,nbxvar,nbzvar,nbdata,nbaddpar,prm,parname,nbobs, &
   ...
   case (define_var_and_par)
      ...
      parname( 51)='UplimdeltaP'
      parname( 52)='DownlimdeltaP'
      parname( 53)='Tlim'
      parname( 54)='Uplimdis'
      parname( 55)='downlimdis'
      parname( 56)='ratemax'
      parname( 57)='rate'
      parname( 58)='rateh'
      parname( 59)='fref'
...
!vxlv = [vx] + {Re}*[ix] - {Xe}*[iy]
      prm( 39)= vx + prm( 19)*ix - prm( 20)*iy

!vylv = [vy] + {Re}*[iy] + {Xe}*[ix]
      prm( 40)= vy + prm( 19)*iy + prm( 20)*ix
...
!dfup = 1/{Rup}*{Snom}
      prm( 61)= 1/prm( 34)*prm( 60)

!dfdn = 1/{Rdn}*{Snom}
      prm( 62)= 1/prm( 35)*prm( 60)
...
!Iqmax =  dsqrt({IN}**2 - {Ipref}**2 )
      x( 13)= dsqrt(prm( 38)**2 - prm( 45)**2 )

!Iqmin =  - dsqrt({IN}**2 - {Ipref}**2 )
      x( 14)= - dsqrt(prm( 38)**2 - prm( 45)**2 )

!Ipmaxi =  {IN}
      x( 15)= prm( 38)

!Ipmax =  min({IN},{PMPP}/{Vref})
      x( 16)= min(prm( 38),prm(  1)/prm( 41))
...
!vq =  -{vxlv}*sin({theta_PLL}) + {vylv}*cos({theta_PLL})
      x( 21)= -prm( 39)*sin(prm( 47)) + prm( 40)*cos(prm( 47))

!vd =  {vxlv}*cos({theta_PLL}) + {vylv}*sin({theta_PLL})
      x( 22)= prm( 39)*cos(prm( 47)) + prm( 40)*sin(prm( 47))
...
!omegam =  -0.5*({vxlv}*sin({theta_PLL}) - {vylv}*cos({theta_PLL})) + 1
      x( 39)= -0.5*(prm( 39)*sin(prm( 47)) - prm( 40)*cos(prm( 47))) + 1

!fm =  50*(-0.5*({vxlv}*sin({theta_PLL}) - {vylv}*cos({theta_PLL})) + 1)
      x( 40)= 50*(-0.5*(prm( 39)*sin(prm( 47)) - prm( 40)*cos(prm( 47))) + 1)

!fmfilt =  50*(-0.5*({vxlv}*sin({theta_PLL}) - {vylv}*cos({theta_PLL})) + 1)
      x( 41)= 50*(-0.5*(prm( 39)*sin(prm( 47)) - prm( 40)*cos(prm( 47))) + 1)
...
!wpll =  -({vxlv}*sin({theta_PLL}) - {vylv}*cos({theta_PLL}))*{kpll} + 2*pi*50
      x( 51)= -(prm( 39)*sin(prm( 47)) - prm( 40)*cos(prm( 47)))*prm( 46) + 2*pi*50
...
!& tf1p2lim
      ...
      if(1*x( 11)-x( 30)>prm( 56)*prm(  4))then
         z(  3)=1
      elseif(1*x( 11)-x( 30)<prm( 49)*prm(  4))then
         z(  3)=-1
      else
         z(  3)=0
      endif
...
!& tf1p2lim
      ...
      if(1*x( 55)-x( 54)>prm( 57)*prm( 53))then
         z( 11)=1
      elseif(1*x( 55)-x( 54)<prm( 49)*prm( 53))then
         z( 11)=-1
      else
         z( 11)=0
      endif
...
!& tf1p2lim
      ...
      if(1*x( 78)-x( 60)>prm( 58)*prm( 53))then
         z( 16)=1
      elseif(1*x( 78)-x( 60)<prm( 49)*prm( 53))then
         z( 16)=-1
      else
         z( 16)=0
      endif
...
!& tf1p2lim
      ...
      if(1*x( 67)-x( 66)>prm( 58)*prm( 53))then
         z( 26)=1
      elseif(1*x( 67)-x( 66)<prm( 49)*prm( 53))then
         z( 26)=-1
      else
         z( 26)=0
      endif
...
!& tf1p2lim
      ...
      if(1*x( 73)-x( 72)>prm( 58)*prm( 53))then
         z( 30)=1
      elseif(1*x( 73)-x( 72)<prm( 49)*prm( 53))then
         z( 30)=-1
      else
         z( 30)=0
      endif
...
!& tf1p2lim
      select case (z(  3))
         ...
         case(1)
            f( 13)=x( 96)-prm( 56)*prm(  4)
         case(-1)
            f( 13)=x( 96)-prm( 49)*prm(  4)
      end select
      select case (z(  4))
         case(0)
            f( 14)=x( 96)
...
!& algeq 				  ! Active - reactive power priority, compute max and min reactive current
      f( 15)=x( 13) -x( 36)*dsqrt(max(0.d0,prm( 38)**2 - x( 11)**2)) - (1-x( 36))*(prm( 30)*prm( 38)*0.707 + (1-prm( 30))*prm( 38))

!& algeq
      f( 16)=x( 14) + x( 36)*dsqrt(max(0.d0,prm( 38)**2 - x( 11)**2)) + (1-x( 36))*prm( 38)

!& algeq                 ! reactive current computation limit and update
      f( 17)=-x( 25) + prm( 44) - x( 29)
...
!& algeq 				  ! Active - reactive power priority, max active current, converter limit
      f( 21)=x( 15) - x( 36)*prm( 38) -  (1-x( 36))*dsqrt(max(0.d0,prm( 38)**2 - x( 12)**2))
...
!& db 						! Reactive current injection, voltage support
      select case (z(  6))
         case(0)
            f( 23)=x( 25)
         case(-1)
            f( 23)=x( 25)-(-prm( 24)*prm( 38)*(prm( 21) + prm( 30)))-(prm( 22)*prm( 38)*(prm( 21) + prm( 30) ))*(x(  7)-prm( 26))
         case(1)
            f( 23)=x( 25)-prm( 25)*prm( 38)-prm( 23)*prm( 38)*prm( 28)*(x(  7)-prm( 27))
      end select
...
!& tf1p2lim
      select case (z( 11))
         ...
         case(1)
            f( 34)=x( 98)-prm( 57)*prm( 53)
         case(-1)
            f( 34)=x( 98)-prm( 49)*prm( 53)
      end select
      select case (z( 12))
         case(0)
            f( 35)=x( 98)
...
!& tf1p2lim
      select case (z( 16))
         ...
         case(1)
            f( 44)=x( 99)-prm( 58)*prm( 53)
         case(-1)
            f( 44)=x( 99)-prm( 49)*prm( 53)
      end select
      select case (z( 17))
         case(0)
            f( 45)=x( 99)
...
!& tf1p2lim
      select case (z( 26))
         ...
         case(1)
            f( 71)=x(101)-prm( 58)*prm( 53)
         case(-1)
            f( 71)=x(101)-prm( 49)*prm( 53)
      end select
      select case (z( 27))
         case(0)
            f( 72)=x(101)
...
!& tf1p2lim
      select case (z( 30))
         ...
         case(1)
            f( 78)=x(102)-prm( 58)*prm( 53)
         case(-1)
            f( 78)=x(102)-prm( 49)*prm( 53)
      end select
      select case (z( 31))
         case(0)
            f( 79)=x(102)
...
!& lim           ! limit power change during underfrequencies
      select case (z( 33))
         ...
         case(1)
            f( 83)=x( 92)-(prm( 60)+prm( 42))
      end select

!& algeq       ! compute unlimited power change during overfrequency
      f( 84)=-x( 93) - x( 77) * prm( 62)
...
!& algeq
      f( 87)=x( 46)+prm( 42)-x( 95)

!& algeq                ! frequency deviation in Hz
      f( 88)=-x( 82) + x( 41)-prm( 59)*50

!& tfder1p               ! Rocof measurement in Hz/s
      f( 89)=-x(103)+x( 82)
      if (prm( 36)< 0.005)then
         f( 90)=1/prm( 36)*x( 82)-x( 83)
      else
         f( 90)=1/prm( 36)*(x( 82)-x(103))-x( 83)
      endif
...
!& tf1p2lim
      select case (z(  3))
         case(0)
            if(x( 96)>prm( 56)*prm(  4))then
               z(  3)=1
            elseif(x( 96)<prm( 49)*prm(  4))then
               z(  3)=-1
            endif
         case(1)
            if(1*x( 11)-x( 30)<prm( 56)*prm(  4))then
         ...
         case(-1)
            if(1*x( 11)-x( 30)>prm( 49)*prm(  4))then
               z(  3)= 0
            endif
      end select
      select case (z(  4))
...
!& tf1p2lim
      select case (z( 11))
         case(0)
            if(x( 98)>prm( 57)*prm( 53))then
               z( 11)=1
            elseif(x( 98)<prm( 49)*prm( 53))then
               z( 11)=-1
            endif
         case(1)
            if(1*x( 55)-x( 54)<prm( 57)*prm( 53))then
         ...
         case(-1)
            if(1*x( 55)-x( 54)>prm( 49)*prm( 53))then
               z( 11)= 0
            endif
      end select
      select case (z( 12))
...
!& tf1p2lim
      select case (z( 16))
         case(0)
            if(x( 99)>prm( 58)*prm( 53))then
               z( 16)=1
            elseif(x( 99)<prm( 49)*prm( 53))then
               z( 16)=-1
            endif
         case(1)
            if(1*x( 78)-x( 60)<prm( 58)*prm( 53))then
         ...
         case(-1)
            if(1*x( 78)-x( 60)>prm( 49)*prm( 53))then
               z( 16)= 0
            endif
      end select
      select case (z( 17))
...
!& tf1p2lim
      select case (z( 26))
         case(0)
            if(x(101)>prm( 58)*prm( 53))then
               z( 26)=1
            elseif(x(101)<prm( 49)*prm( 53))then
               z( 26)=-1
            endif
         case(1)
            if(1*x( 67)-x( 66)<prm( 58)*prm( 53))then
         ...
         case(-1)
            if(1*x( 67)-x( 66)>prm( 49)*prm( 53))then
               z( 26)= 0
            endif
      end select
      select case (z( 27))
...
!& tf1p2lim
      select case (z( 30))
         case(0)
            if(x(102)>prm( 58)*prm( 53))then
               z( 30)=1
            elseif(x(102)<prm( 49)*prm( 53))then
               z( 30)=-1
            endif
         case(1)
            if(1*x( 73)-x( 72)<prm( 58)*prm( 53))then
         ...
         case(-1)
            if(1*x( 73)-x( 72)>prm( 49)*prm( 53))then
               z( 30)= 0
            endif
      end select
      select case (z( 31))
