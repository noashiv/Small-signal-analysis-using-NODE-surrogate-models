!  MODEL NAME : inj_BESSrc              
!  MODEL DESCRIPTION FILE : BESS_rc.txt
!  Data :
!       prm(  1)=  Imax
!       prm(  2)=  IN
!       prm(  3)=  Iprate
...
!       prm( 39)=  SOCmin
!       prm( 40)=  SOCmax
!       prm( 41)=  Capacity            ! capacity of battery in MWh
!  Parameters :
!       prm( 42)=  vxlv  
!       prm( 43)=  vylv  
!       prm( 44)=  Vref  
...
subroutine inj_BESSrc(nb,name,mode,nbxvar,nbzvar,nbdata,nbaddpar,prm,parname,nbobs, &
...
!vxlv = [vx] + {Re}*[ix] - {Xe}*[iy]
      prm( 42)= vx + prm( 19)*ix - prm( 20)*iy

!vylv = [vy] + {Re}*[iy] + {Xe}*[ix]
      prm( 43)= vy + prm( 19)*iy + prm( 20)*ix
...
!Iqmax =  dsqrt({Imax}**2 - {Ipref}**2 )
      x( 13)= dsqrt(prm(  1)**2 - prm( 48)**2 )

!Iqmin =  - dsqrt({Imax}**2 - {Ipref}**2 )
      x( 14)= - dsqrt(prm(  1)**2 - prm( 48)**2 )
...
!vq =  -{vxlv}*sin({theta_PLL}) + {vylv}*cos({theta_PLL})
      x( 20)= -prm( 42)*sin(prm( 50)) + prm( 43)*cos(prm( 50))

!vd =  {vxlv}*cos({theta_PLL}) + {vylv}*sin({theta_PLL})
      x( 21)= prm( 42)*cos(prm( 50)) + prm( 43)*sin(prm( 50))
...
!omegam =  -0.5*({vxlv}*sin({theta_PLL}) - {vylv}*cos({theta_PLL})) + 1
      x( 38)= -0.5*(prm( 42)*sin(prm( 50)) - prm( 43)*cos(prm( 50))) + 1

!fm =  50*(-0.5*({vxlv}*sin({theta_PLL}) - {vylv}*cos({theta_PLL})) + 1)
      x( 39)= 50*(-0.5*(prm( 42)*sin(prm( 50)) - prm( 43)*cos(prm( 50))) + 1)

!fmfilt =  50*(-0.5*({vxlv}*sin({theta_PLL}) - {vylv}*cos({theta_PLL})) + 1)
      x( 40)= 50*(-0.5*(prm( 42)*sin(prm( 50)) - prm( 43)*cos(prm( 50))) + 1)
...
!wpll =  -({vxlv}*sin({theta_PLL}) - {vylv}*cos({theta_PLL}))*{kpll} + 2*pi*50
      x( 50)= -(prm( 42)*sin(prm( 50)) - prm( 43)*cos(prm( 50)))*prm( 49) + 2*pi*50
...
!& tf1p2lim
      ...
      if(1*x( 11)-x( 29)>prm( 59)*prm(  4))then
         z(  3)=1
      elseif(1*x( 11)-x( 29)<prm( 52)*prm(  4))then
         z(  3)=-1
      else
         z(  3)=0
      endif
...
!& tf1p2lim
      ...
      if(1*x( 54)-x( 53)>prm( 60)*prm( 56))then
         z( 11)=1
      elseif(1*x( 54)-x( 53)<prm( 52)*prm( 56))then
         z( 11)=-1
      else
         z( 11)=0
      endif
...
!& tf1p2lim
      ...
      if(1*x( 82)-x( 59)>prm( 61)*prm( 56))then
         z( 16)=1
      elseif(1*x( 82)-x( 59)<prm( 52)*prm( 56))then
         z( 16)=-1
      else
         z( 16)=0
      endif
...
!& tf1p2lim
      ...
      if(1*x( 66)-x( 65)>prm( 61)*prm( 56))then
         z( 26)=1
      elseif(1*x( 66)-x( 65)<prm( 52)*prm( 56))then
         z( 26)=-1
      else
         z( 26)=0
      endif
...
!& tf1p2lim
      ...
      if(1*x( 72)-x( 71)>prm( 61)*prm( 56))then
         z( 30)=1
      elseif(1*x( 72)-x( 71)<prm( 52)*prm( 56))then
         z( 30)=-1
      else
         z( 30)=0
      endif
...
!& tf1p2lim
      select case (z(  3))
         case(0)
            f( 13)=x(101)-1*x( 11)+x( 29)
         case(1)
            f( 13)=x(101)-prm( 59)*prm(  4)
         case(-1)
            f( 13)=x(101)-prm( 52)*prm(  4)
      end select
      select case (z(  4))
         case(0)
            f( 14)=x(101)
...
!& algeq 				  ! Active - reactive power priority, max active current
      f( 21)=x( 15) - (x( 35)*prm(  2) -  (1-x( 35))*dsqrt(max(0.d0,prm(  1)**2 - x( 12)**2)) )*(1-x( 97))
...
!& tf1p2lim
      select case (z( 11))
         case(0)
            f( 33)=x(103)-1*x( 54)+x( 53)
         case(1)
            f( 33)=x(103)-prm( 60)*prm( 56)
         case(-1)
            f( 33)=x(103)-prm( 52)*prm( 56)
      end select
      select case (z( 12))
         case(0)
            f( 34)=x(103)
...
!& tf1p2lim
      select case (z( 16))
         case(0)
            f( 43)=x(104)-1*x( 82)+x( 59)
         case(1)
            f( 43)=x(104)-prm( 61)*prm( 56)
         case(-1)
            f( 43)=x(104)-prm( 52)*prm( 56)
      end select
      select case (z( 17))
         case(0)
            f( 44)=x(104)
...
!& pictl
      ...
      f( 51)=0.5/(prm( 10)*0.001)                                                                                                                                                                                                                                                                                        *x( 20)+x(105)-x( 50)
...
!& tf1p2lim
      select case (z( 26))
         case(0)
            f( 70)=x(106)-1*x( 66)+x( 65)
         case(1)
            f( 70)=x(106)-prm( 61)*prm( 56)
         case(-1)
            f( 70)=x(106)-prm( 52)*prm( 56)
      end select
      select case (z( 27))
         case(0)
            f( 71)=x(106)
...
!& tf1p2lim
      select case (z( 30))
         case(0)
            f( 77)=x(107)-1*x( 72)+x( 71)
         case(1)
            f( 77)=x(107)-prm( 61)*prm( 56)
         case(-1)
            f( 77)=x(107)-prm( 52)*prm( 56)
      end select
      select case (z( 31))
         case(0)
            f( 78)=x(107)
...
!& algeq
      f( 86)=x( 45)+prm( 45)-x( 81)

!& algeq                ! frequency deviation in Hz
      f( 87)=-x( 86) + x( 40)-prm( 62)*50

!& tfder1p               ! Rocof measurement in Hz/s
      f( 88)=-x(108)+x( 86)
      if (prm( 36)< 0.005)then
         f( 89)=1/prm( 36)*x( 86)-x( 87)
      else
         f( 89)=1/prm( 36)*(x( 86)-x(108))-x( 87)
      endif
...
!& algeq
      f(104)=-x( 99) + prm( 38) - x(100)/prm( 41)

!& algeq
      f(105)=x( 95) + x( 99) - prm( 39)
...
!& tf1p2lim
      select case (z(  3))
         case(0)
            if(x(101)>prm( 59)*prm(  4))then
               z(  3)=1
            elseif(x(101)<prm( 52)*prm(  4))then
               z(  3)=-1
            endif
         case(1)
            if(1*x( 11)-x( 29)<prm( 59)*prm(  4))then
...
!& timer5
      ...
      if(z(  7) == 0)then
         ...
         elseif(x( 31) > (-(prm( 29)*prm( 13) + (1-prm( 29))*prm( 31))))then
            if(x(102) > prm(  6)+(0.-prm(  6))*(x( 31)-(-(prm( 29)*prm( 13) + (1-prm( 29))*prm( 31))))/((-(prm( 29)*prm( 13) + (1-prm( 29))*prm( 31)))-(-(prm( 29)*prm( 13) + (1-prm( 29))*prm( 31)))))then
               z(  7)=1
            endif
         elseif(x( 31) > (-(prm( 29)*prm( 14) + (1-prm( 29))*prm( 31))))then
            if(x(102) > prm(  6)+(prm(  6)-prm(  6))*(x( 31)-(-(prm( 29)*prm( 14) + (1-prm( 29))*prm( 31))))/((-(prm( 29)*prm( 13) + (1-prm( 29))*prm( 31)))-(-(prm( 29)*prm( 14) + (1-prm( 29))*prm( 31)))))then
               z(  7)=1
            endif
         elseif(x( 31) > (-(prm( 29)*prm( 14) + (1-prm( 29))*prm( 31))))then
            if(x(102) > prm(  8)+(prm(  6)-prm(  8))*(x( 31)-(-(prm( 29)*prm( 14) + (1-prm( 29))*prm( 31))))/((-(prm( 29)*prm( 14) + (1-prm( 29))*prm( 31)))-(-(prm( 29)*prm( 14) + (1-prm( 29))*prm( 31)))))then
               z(  7)=1
            endif
         elseif(x( 31) > (-prm( 12)))then
            if(x(102) > prm(  7)+(prm(  8)-prm(  7))*(x( 31)-(-prm( 12)))/((-(prm( 29)*prm( 14) + (1-prm( 29))*prm( 31)))-(-prm( 12))))then
               z(  7)=1
            endif
         endif
      endif
...
!& tf1p2lim
      select case (z( 11))
         case(0)
            if(x(103)>prm( 60)*prm( 56))then
               z( 11)=1
            elseif(x(103)<prm( 52)*prm( 56))then
               z( 11)=-1
            endif
         case(1)
            if(1*x( 54)-x( 53)<prm( 60)*prm( 56))then
         ...
         case(-1)
            if(1*x( 54)-x( 53)>prm( 52)*prm( 56))then
               z( 11)= 0
            endif
      end select
      select case (z( 12))
...
!& tf1p2lim
      select case (z( 16))
         case(0)
            if(x(104)>prm( 61)*prm( 56))then
               z( 16)=1
            elseif(x(104)<prm( 52)*prm( 56))then
               z( 16)=-1
            endif
         case(1)
            if(1*x( 82)-x( 59)<prm( 61)*prm( 56))then
         ...
         case(-1)
            if(1*x( 82)-x( 59)>prm( 52)*prm( 56))then
               z( 16)= 0
            endif
      end select
      select case (z( 17))
...
!& tf1p2lim
      select case (z( 26))
         ...
         case(-1)
            if(1*x( 66)-x( 65)>prm( 52)*prm( 56))then
               z( 26)= 0
            endif
      end select
      select case (z( 27))
...
!& tf1p2lim
      select case (z( 30))
         ...
         case(-1)
            if(1*x( 72)-x( 71)>prm( 52)*prm( 56))then
               z( 30)= 0
            endif
      end select
      select case (z( 31))
